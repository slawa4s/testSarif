...
{
    int actual = get_size_of_data({'c', {'c', 'c', 'b', 'c', 'c', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'c', 'a', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b', 'a', 'c', 'c', 'c', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'c', 'a', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b', 'c', 'c', 'c', 'b', 'c', 'b', 'c', 'c', 'c', 'c', 'c'}});
...
TEST(regression, different_test_1)
{
    ...
    char expected_new_[] = {'c', 'c', 'c', 'b', 'c', 'c', 'c', 'c', 'c', '\0'};
