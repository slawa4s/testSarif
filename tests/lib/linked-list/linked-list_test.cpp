...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {-33686019, NULL};
    struct Node utbotInnerVar2 = {0, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = cycle_list3(&head);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {252645135, NULL};
    struct Node utbotInnerVar2 = {555819297, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
...
TEST(regression, cycle_list3_test_8)
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, NULL};
    struct Node utbotInnerVar2 = {0, (struct Node *) 288230380446679044};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    int actual = cycle_list3(&head);
    EXPECT_EQ(17, actual);
...
TEST(regression, sort_list_with_comparator_test_1)
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, NULL};
    struct Node utbotInnerVar2 = {-1195853640, NULL};
    struct Node utbotInnerVar3 = {0, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {0, 1, 1, -1, 2, 1, 1, 2, 2, 0};
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {1819044972, NULL};
    struct Node utbotInnerVar2 = {-1195853640, NULL};
    struct Node utbotInnerVar3 = {0, NULL};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {1, 1, 1, -1, 2, 1, 0, 2, 2, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(-1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_4)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {1, 1, 1, -1, 2, 1, 1, 2, 0, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(-1, actual);
    struct Node expected_head = {0, NULL};
...
TEST(regression, sort_list_with_comparator_test_5)
{
    ...
    utbotInnerVar1.next = &utbotInnerVar2;
    utbotInnerVar2.next = &utbotInnerVar3;
    int cmp_symbolic_buffer[10] = {1, 1, 1, -1, 2, 1, 1, 2, 2, 0};
    memcpy((void *) cmp_symbolic, cmp_symbolic_buffer, sizeof(cmp_symbolic_buffer));
    int actual = sort_list_with_comparator(&head, _sort_list_with_comparator_cmp_stub);
    EXPECT_EQ(1, actual);
    struct Node expected_head = {0, NULL};
...
{
    char vowel_symbolic_buffer[] = {'o', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
...
{
    char vowel_symbolic_buffer[] = {'e', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('c', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'y', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('c', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'b', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('c', _vowel_consonant_vowel_stub);
    EXPECT_EQ(-1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'u', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('c', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'i', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('c', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    char vowel_symbolic_buffer[] = {'a', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'b'};
    memcpy((void *) vowel_symbolic, vowel_symbolic_buffer, sizeof(vowel_symbolic_buffer));
    int actual = vowel_consonant('c', _vowel_consonant_vowel_stub);
    EXPECT_EQ(1, actual);
}
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {67372036, (struct Node *) 1125899906842632};
    head.next = &utbotInnerVar1;
    length_of_linked_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {1061109567, (struct Node *) 4567822147193552648};
    head.next = &utbotInnerVar1;
    sum_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 254};
    head.next = &utbotInnerVar1;
    sum_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {1482184792, NULL};
    struct Node utbotInnerVar2 = {0, (struct Node *) 247};
    head.next = &utbotInnerVar1;
    utbotInnerVar1.next = &utbotInnerVar2;
    sign_sum(&head);
    struct Node expected_head = {0, NULL};
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 524296};
    head.next = &utbotInnerVar1;
    sign_sum(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 2413929400270585864};
    head.next = &utbotInnerVar1;
    cycle_list3(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 40};
    head.next = &utbotInnerVar1;
    len_bound(&head, 3);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {0, (struct Node *) 13431985888632505344};
    head.next = &utbotInnerVar1;
    sort_list(&head);
    struct Node expected_head = {0, NULL};
    EXPECT_EQ(expected_head.x, head.x);
...
{
    struct Node head = {0, NULL};
    struct Node utbotInnerVar1 = {-1296911694, (struct Node *) 14817005883110896192};
    head.next = &utbotInnerVar1;
