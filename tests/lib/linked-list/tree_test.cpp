...
{
    struct Tree root = {NULL, NULL};
    struct Tree utbotInnerVar1 = {(struct Tree *) 8680820740569200760, NULL};
...
{
    struct Tree root = {NULL, (struct Tree *) 11529215046068469768};
    struct Tree utbotInnerVar1 = {(struct Tree *) 11574427654092267680, (struct Tree *) 11529215046068469768};
    root.left = &utbotInnerVar1;
    deep(&root);
    struct Tree expected_root = {NULL, NULL};
}
