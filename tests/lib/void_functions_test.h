...
extern "C" void print_sign_lib_void_functions_c(int a);
static void print_sign(int a) {
return print_sign_lib_void_functions_c(a);
}
extern "C" void print_signs_for_two_structs_lib_void_functions_c(struct ThisStruct thisStr1, struct ThisStruct thisStr2);
static void print_signs_for_two_structs(struct ThisStruct thisStr1, struct ThisStruct thisStr2) {
return print_signs_for_two_structs_lib_void_functions_c(thisStr1, thisStr2);
}
extern "C" void print_value_lib_void_functions_c(int a);
static void print_value(int a) {
return print_value_lib_void_functions_c(a);
}
