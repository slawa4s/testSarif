...
{
    long long actual = sum_of_all_fields_or_mult({5LL, 9, {-9, (char *) 17868022691004938231}}, -322);
...
{
    long long actual = sum_of_all_fields_or_mult({9LL, 1, {0, NULL}}, -322);
    EXPECT_EQ(9LL, actual);
}

TEST(regression, sum_of_all_fields_or_mult_test_4)
{
    long long actual = sum_of_all_fields_or_mult({9LL, 1, {0, NULL}}, 0);
    EXPECT_EQ(9LL, actual);
}
...
{
    struct StructWithPointerInField actual = some_calc(-8, 1);
...
{
    struct StructWithPointerInField actual = some_calc(10, -1);
    struct StructWithPointerInField expected = {33333LL, 33, {3, NULL}};
    EXPECT_EQ(actual.ll, expected.ll);
    EXPECT_EQ(actual.sh, expected.sh);
    EXPECT_EQ(actual.a.a, expected.a.a);
...
{
    struct StructWithPointerInField actual = some_calc(-4, -4);
    struct StructWithPointerInField expected = {0LL, 0, {0, NULL}};
    EXPECT_EQ(actual.ll, expected.ll);
    EXPECT_EQ(actual.sh, expected.sh);
    EXPECT_EQ(actual.a.a, expected.a.a);
...
{
    struct List head = {NULL, 0};
    struct List utbotInnerVar1 = {(struct List *) 251, 0};
...
{
    struct List head = {NULL, 0};
    struct List utbotInnerVar1 = {(struct List *) 18446744073709486080, 0};
    head.next = &utbotInnerVar1;
    list_sum(&head);
    struct List expected_head = {NULL, 0};
    EXPECT_EQ(expected_head.val, head.val);
...
{
    struct List head = {NULL, 0};
    struct List utbotInnerVar1 = {(struct List *) 2251799813685256, 0};
    head.next = &utbotInnerVar1;
    list_sum_sign(&head);
    struct List expected_head = {NULL, 0};
    EXPECT_EQ(expected_head.val, head.val);
