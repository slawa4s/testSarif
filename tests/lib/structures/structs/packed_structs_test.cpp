...
{
    int actual = get_sign_packedStruct1({0, -9});
    EXPECT_EQ(-1, actual);
}
...
{
    char actual = get_val_by_packedStruct2({'a', 0, {'i', 0}});
    EXPECT_EQ('3', actual);
}
...
{
    short actual = get_val_by_otherPackedStruct({'r', {'c', 0, {'c', 0}}, 'b', 0});
    EXPECT_EQ(-1, actual);
}
...
{
    short actual = get_val_by_otherPackedStruct({'r', {'S', 0, {'c', 0}}, 'b', 0});
    EXPECT_EQ(5, actual);
}
