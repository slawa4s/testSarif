...
{
    int actual = struct_has_alphabet({0, {'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}

TEST(regression, struct_has_alphabet_test_3)
{
    int actual = struct_has_alphabet({0, {'A', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}

TEST(regression, struct_has_alphabet_test_4)
{
    int actual = struct_has_alphabet({2, {'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c', 'c'}});
    EXPECT_EQ(0, actual);
}
...
{
    char actual = arrays_in_inner_structs({{'b', 'c'}, 1, {{0, 0, 0, 0, 0}}});
    EXPECT_EQ('1', actual);
}
...
{
    char actual = arrays_in_inner_structs({{'c', 'g'}, 1, {{0, 0, 0, 0, 0}}});
    EXPECT_EQ('1', actual);
}
