...
{
    char actual = get_symbol_by_struct({'c', 'p', 99, 0});
    EXPECT_EQ('0', actual);
}

TEST(regression, get_symbol_by_struct_test_2)
{
    char actual = get_symbol_by_struct({'c', 'p', 117, 0});
    EXPECT_EQ('u', actual);
}

TEST(regression, get_symbol_by_struct_test_3)
{
    char actual = get_symbol_by_struct({'c', 'p', 99, 1});
    EXPECT_EQ('1', actual);
}

TEST(regression, get_symbol_by_struct_test_4)
{
    char actual = get_symbol_by_struct({'c', 'c', 99, 0});
    EXPECT_EQ('c', actual);
}
...
{
    signed char actual = operate_with_inner_structs({{'c', {0U, 2LL}, 0}, 0, 0LL});
    EXPECT_EQ('o', actual);
}
...
{
    struct MainStruct actual = struct_as_return_type(8);
